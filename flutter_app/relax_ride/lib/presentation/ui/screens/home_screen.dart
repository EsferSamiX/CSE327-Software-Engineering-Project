                      ...
                      child: Padding(
                        ...
                        child: TextField(
                          ...
                          decoration: InputDecoration(
                            labelText: 'Date',
                            labelStyle: TextStyle(fontSize: 15, color: Colors.teal.shade800),
                            prefixIcon: Icon(
        ...
        return Theme(
          data: Theme.of(context).copyWith(
            colorScheme: ColorScheme.light(
              ...
              onSurface: Colors.teal.shade800, // Body text color
            ),
            dialogBackgroundColor: Colors.white, // Background color
            textButtonTheme: TextButtonThemeData(
              style: TextButton.styleFrom(
                foregroundColor: Colors.teal.shade600, // Button text color
              ),
            ),
          ),
          child: child!,
