    ...
    try {
      final response = await http.post(
        ...
        body: jsonEncode(<String, String>{
          ...
          'date': widget.selectedData!.trim() ?? '2022-12-12',
        }),
      );
              ...
              Column(
                children: [
                  Row(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Icon(Icons.schedule, color: Colors.teal.shade800),
                      const SizedBox(width: 5),
                      Text(data.departTime.toString(), style: TextStyle(color: Colors.teal.shade800)),
                  ...
                  Row(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('Hino 1J Series, AC', style: TextStyle(color: Colors.teal.shade800)),
